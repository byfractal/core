...
const MOCK_OPTIMIZATIONS: Optimization[] = [
  {
    ...
    description: "Optimize the homepage layout and reduce friction points",
    impact: "high",
    type: "layout",
  ...
  },
  {
    ...
    projectId: "p2",
    title: "Checkout Flow",
    description: "Improve the checkout flow to increase conversions",
    impact: "medium",
    type: "conversion",
  ...
  },
  {
    ...
    description: "Enhance the mobile dashboard performance",
    impact: "low",
    type: "performance",
...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({ className }) => {
  const [optimizations, setOptimizations] =
    useState<Optimization[]>(MOCK_OPTIMIZATIONS);
  ...
  return (
    <div className={cn("flex flex-col w-full h-full p-6", className)}>
      ...
      <p className="text-figma-text-secondary font-inter text-sm mb-6">
        You can import data, analyze pages, and improve user experience based on
        real product insights.
      </p>
